...
$functionVersions['enhanced_mail']=1.00;
function enhanced_mail($to, $subject, $body, $from, $mode=plain, $fileArray='', $important=0, $preHeaders='', $postHeaders='', $output='mail', $fSwitchEmail=''){
	global $mimeTypes, $fileMemory;
