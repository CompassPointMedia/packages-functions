...
function CMSB($section='', $method='', $options=array()){
	...
	*/
	global $fl,$ln,$qr,$qx, $developerEmail,$fromHdrBugs, $CMSB,$CMSBx, $thispage, $thisfolder, $adminMode, $pJCurrentContentRegion, $JULIET_COMPONENT_ROOT, $MASTER_COMPONENT_ROOT;
	...
	if(strtolower($method)=='static:default'){
		...
		ob_start();
		?>
		<a class="_editLink_" id="CMSB-<?php echo $section?>" method="<?php echo $method?>" title="Edit the section <?php echo strtolower($linkPosition)=='below'?'above':'below'?>:<?php echo $section?>"<?php if(isset($commonfolder)){ ?> commonfolder="<?php echo h($commonfolder);?>"<?php } ?><?php if(isset($commonpage)){ ?> commonpage="<?php echo $commonpage?>"<?php } ?> href="#" onclick="return CMSBedit(g('<?php echo 'CMSB-'.$section;?>'), '<?php echo strtolower($method);?>', [CMSB_SECTION_TOKEN]);"><img src="/images/i/plus.jpg" alt="hide" onclick="this.parentNode.style.display='none'; return false;" title="click to hide link" width="13" height="13" />[<?php echo $editSectionLabel?>]</a><?php
		...
		ob_start();
		?>
		<a class="_editLink_" id="CMSB-<?php echo $section?>" method="<?php echo $method?>"<?php if(isset($commonfolder)){ ?> commonfolder="<?php echo h($commonfolder);?>"<?php } ?><?php if(isset($commonpage)){ ?> commonpage="<?php echo $commonpage?>"<?php } ?> title="Edit the section <?php echo strtolower($linkPosition)=='below'?'above':'below'?>:<?php echo $section?>" <?php echo $parameterAttributes;?> href="#" onclick="return CMSBedit(g('<?php echo 'CMSB-'.$section;?>'), '<?php echo strtolower($method);?>', [CMSB_SECTION_TOKEN]);"><img src="/images/i/plus.jpg" alt="hide" onclick="this.parentNode.style.display='none'; return false;" title="click to hide link" width="13" height="13" />[<?php echo $editSectionLabel?>]</a><?php
		$link=ob_get_contents();
		ob_end_clean();
		//-----------------------------------------------------------------
		...
		ob_start();
		?>
		<a class="_editLink_" id="CMSB-<?php echo $section?>" method="<?php echo $method?>" title="Edit the section <?php echo strtolower($linkPosition)=='below'?'above':'below'?>" href="#" onclick="return CMSBedit(g('<?php echo 'CMSB-'.$section;?>'), '<?php echo $method?>', [CMSB_SECTION_TOKEN]);" <?php echo $str?>><img src="/images/i/plus.jpg" alt="hide" onclick="this.parentNode.style.display='none'; return false;" title="click to hide link" width="13" height="13" />[<?php echo $editSectionLabel?>]</a>
		<?php
		$link=ob_get_contents();
		ob_end_clean();
		//-----------------------------------------------------------------
	...
	if($content){
		...
		if(!$adminMode && preg_match('/<div[^>]+class=(\'|")CMSBSlideshow(\'|")[^>]*>((.|\s)+?)<\/div>/i',$content['Content'],$parse)){
