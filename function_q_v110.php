...
function q(){
	...
	**/
	...
	$knownConst=array(1,2,20,21,22,23,40,41,42,43,44,45,100,101,103,104,105,106,107,108,109,110); //this prevents passing constants from an older version to the function
	...
	switch(true){
		...
		case $cnx==C_MASTER:
			...
			global $db_cnx,$MASTER_HOSTNAME, $MASTER_USERNAME, $MASTER_PASSWORD,$MASTER_DATABASE;
